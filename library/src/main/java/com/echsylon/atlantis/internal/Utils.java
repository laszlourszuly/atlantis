...
public class Utils {
     ...
     * @throws IOException If for some reason couldn't open the asset.
     */
    public static byte[] readAsset(Context context, String assetName) throws IOException {
        ...
        try {
            ...
            // Since we opened the input stream it's fair to assume that
            // it's our responsibility to close it as well.
     ...
     * @throws IOException If for some reason couldn't read the input stream.
     */
    ...
    /**
     * Tries to read the entire content of the given file.
     *
     * @param file The file to read bytes from.
     * @return The content of the file as a byte array.
     * @throws IOException If for some reason couldn't read the file.
     */
    ...
    /**
     * Tries to write some text to a file. This method expects the text to be
     * UTF-8 encoded.
     *
     * @param content The text to write.
     * @param file    The file to write to.
     * @throws IOException If for some reason couldn't write to the file.
     */
